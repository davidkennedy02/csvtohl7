...
from hl7_utilities import create_control_id, calculate_age, create_adt_message
...
class TestUtilities(unittest.TestCase):
    ...
    def test_calculate_age(self):
        ...
        expected_age = datetime.now().year - 1990 - ((datetime.now().month, datetime.now().day) < (1, 1))
    ...
    def test_create_msh(self):
        ...
        self.assertEqual(hl7.msh.msh_10, control_id)
    ...
    def test_create_adt_message(self):
        ...
        self.assertEqual(hl7_message.msh.msh_9, "ADT^A01")
    ...
    def test_create_adt_a28_message(self):
        ...
        self.assertIsNotNone(hl7_message)
        self.assertEqual(hl7_message.msh.msh_9, "ADT^A28")
        self.assertFalse(hasattr(hl7_message, 'pv1'))
